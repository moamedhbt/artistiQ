      ...
      >
        ...
        <div>
          <label className="block text-xs font-medium text-gray-200 mb-2">
            Nom & Prénom <span className="text-gold">*</span>
          </label>
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3.5 bg-obsidian border border-obsidian-border rounded-xl text-white placeholder-gray-500 text-sm focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold transition-all"
            />
          </div>
        ...
        <div>
          <label className="block text-xs font-medium text-gray-200 mb-2">
            Téléphone / WhatsApp <span className="text-gold">*</span>
          </label>
          <div className="relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-xs font-medium text-gray-200 mb-2">
              Adresse Exacte <span className="text-gold">*</span>
            </label>
            <div className="relative">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <textarea
              ...
              className="w-full pl-12 pr-4 py-3 bg-obsidian border border-obsidian-border rounded-xl text-white placeholder-gray-500 text-sm focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold transition-all resize-none"
            />
          </div>
        </div>
        ...
        <div className="pt-4">
          <button
            type="submit"
            className="w-full py-4 rounded-xl bg-gradient-to-r from-gold-light via-gold to-gold-dark text-obsidian font-bold text-sm shadow-gold-glow hover:scale-[1.01] active:scale-[0.99] transition-all flex items-center justify-center gap-2"
          >
